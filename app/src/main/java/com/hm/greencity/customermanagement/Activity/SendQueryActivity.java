...
import com.hm.greencity.customermanagement.databinding.ActivitySendQueryBinding;
...
ActivitySendQueryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        binding = ActivitySendQueryBinding.inflate(getLayoutInflater());
    ...
    private void onclicklistener() {
        binding.backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SendQueryActivity.this,ChatActivity.class);
...
//        });
    ...
    private void initview() {
        ...
        editTextMessage = findViewById(R.id.edt_feedback);
        editTextTitle = findViewById(R.id.feedback_title);
...
//        recyclerView.setAdapter(messageAdapter);
    ...
    private void sendMessage() {
        String titleContent = editTextTitle.getText().toString();
        String messageContent = editTextMessage.getText().toString();
        if (!messageContent.isEmpty()|| titleContent.isEmpty() || selectedImageUri != null) {
            ...
            RequestBody title = RequestBody.create(MediaType.parse("text/plain"), titleContent); // Example title
                ...
                public void onResponse(Call<ResponseChat> call, Response<ResponseChat> response) {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if ("200".equals(statusCode)) {
                            Toast.makeText(SendQueryActivity.this, message, Toast.LENGTH_SHORT).show();
                            editTextMessage.setText(""); // Clear the message box
                            selectedImageUri = null; // Clear the selected image URI
                            binding.imageView.setVisibility(View.GONE);
                        } else {
                            Toast.makeText(SendQueryActivity.this, "Failed to send message", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(SendQueryActivity.this, "Failed message", Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onFailure(Call<ResponseChat> call, Throwable t) {
                    Toast.makeText(SendQueryActivity.this, "Something went wrong: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
